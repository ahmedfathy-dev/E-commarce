...
>  
      ...
      <p className="mt-2 text-sm text-neutral-500">Join the collection</p>
      ...
      <label className="mt-5 text-xs font-medium text-neutral-700">
        ...
        <input
          ...
          className="mt-2 w-full rounded-md border border-[#ededed] bg-white px-3 py-2.5 text-sm outline-none transition focus:border-neutral-900"
        />
      </label>
