...
// 👇 نكرر العناصر عشان يبقى infinite
...
function Essentials() {
  ...
  return (
    <div className="px-6 py-10 bg-[#f5f5f5] relative pt-22">
    ...
    <div className="text-center mb-12">
        ...
        <p className="mt-4 text-gray-500 max-w-xl mx-auto animate-fadeUp delay-200">
